...
class Invoice extends Command
{
     ...
     * @var string
     */
    protected $signature = 'cron/qb:invoice {type} {date_start?} {date_end?}';
     ...
     * @var string
     */
    protected $description = 'Get invoice from qb';
    ...
    protected function today()
    {
        ...
        $sql = "SELECT * FROM Invoice WHERE MetaData.CreateTime >= '$dateStart' AND MetaData.CreateTime <= '$dateEnd'";
    ...
    protected function saveData($dataQB)
    {
        ...
        $dataReport = modelQBReport::where('type', 1)
            ->where('date', $date)
