...
class CreativeTableCreate extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('offer_creative', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('offer_id')->nullable()->default(0);
            $table->integer('iteration')->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('offer_creative');
    }
}
