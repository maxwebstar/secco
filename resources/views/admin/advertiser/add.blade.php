    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-default">
                ...
                <form class="" method="post" action="{{ route('admin.advertiser.save.add') }}">
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div id="block-prepay" class="form-group col-md-6 {{ $errors->has('prepay_amount') ? ' has-error' : '' }}">
                                <label for="" class="control-label" style="opacity: 0">Prepay Amount</label>
                                <div class="form-inline">
                                    ...
                                    &nbsp;&nbsp;
                                    <input type="text" class="form-control {{ old('prepay') ? "" : " hidden"}}" name="prepay_amount" placeholder="Enter Prepay Amount" value="{{ old('prepay_amount') }}">
                                </div>
                        ...
                        <div class="form-group {{ $errors->has('state') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="state">
                                ...
                                @foreach($dataState as $iter)
                                    <option value="{{ $iter->key }}" {{ old('state') == $iter->key ? " selected" : "" }}>{{ $iter->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <input type="hidden" name="pipedrive_id" value="{{ old('pipedrive_id') ? : $data->pipedrive_id }}">
                    </div>
