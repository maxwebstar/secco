    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-default">
                ...
                <form class="" method="post" action="{{ route('admin.advertiser.save.edit') }}">
                    <div class="box-body">
                        ...
                        <div class="form-group {{ ($errors->has('street1') || $errors->has('street2')) ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="street2" placeholder="Address line 2" value="{{ old('street2') ? : $data->street2 }}" style="margin-top: 7px;">
                        ...
                        <div class="form-group {{ $errors->has('province') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="province" placeholder="Enter Province" value="{{ old('province') ? : $data->province }}">
                        ...
                        <div class="form-group {{ $errors->has('phone') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="phone" placeholder="Enter Phone" value="{{ old('phone') ? : $data->phone }}" required>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 {{ $errors->has('cap') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" name="cap" placeholder="Enter Credit Cap" value="{{ old('cap') ? : $data->cap }}">
                            ...
                            <div id="block-prepay" class="form-group col-md-6 {{ $errors->has('prepay_amount') ? ' has-error' : '' }}">
                                ...
                                <div class="form-inline">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="prepay" value="1" {{ (old('prepay') ? : $data->prepay) ? " checked" : ""}}> Prepay
                                        </label>
                                    </div>
                                    &nbsp;&nbsp;
                                    <input type="text" class="form-control {{ (old('prepay') ? : $data->prepay) ? "" : " hidden"}}" name="prepay_amount" placeholder="Prepay amount" value="{{ old('prepay_amount') ? : $data->prepay_amount }}">
                                </div>
                        ...
                        <div class="row">
                            <div id="block-frequency" class="form-group col-md-6 {{ $errors->has('frequency_id') ? ' has-error' : '' }}">
                                ...
                                <select class="form-control" name="frequency_id">
                                    ...
                                    @foreach($dataFrequency as $iter)
                                        <option value="{{ $iter->id }}" {{ (old('frequency_id') ? : $data->frequency_id) == $iter->id ? " selected" : "" }}>{{ $iter->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div id="block-frequency-custom" class="form-group col-md-6 {{ $errors->has('frequency_custom') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control {{ ((old('frequency_id') ? : $data->frequency_id) == 4 || old('frequency_custom')) ? "" : " hidden" }}"
                    ...
                    <div class="box-footer">
                        ...
                        @if($data->google_folder)
                            <a class="btn btn-info pull-right" target="_blank" style="margin-right: 10px;" href="https://drive.google.com/drive/folders/{{ $data->google_folder }}" role="button">Google Folder</a>
                        @endif
                    </div>
                </form>
