    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-default">
                ...
                <form class="" method="post" action="{{ route('admin.email.template.group.save') }}">
                <div class="box-body">
                    ...
                    <div class="form-group {{ $errors->has('show') ? ' has-error' : '' }}">
                        <div class="checkbox">
                            <label><input type="checkbox" name="show" value="1" {{ (old('show') ? old('show') : $data->show) ? " checked" : "" }}><strong>Show</strong></label>
                        </div>
                        @if ($errors->has('show'))
                            <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <a class="btn btn-default pull-right" href="{{ route('admin.email.template.group') }}" role="button">Back to Template groups</a>
                </div>
                </form>
