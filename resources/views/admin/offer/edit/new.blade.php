        ...
        <div class="col-md-12">
            ...
            <div class="box box-default">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">Edti Offer</h3>
                </div>

                <form class="" method="post" action="{{ route('admin.offer.save.edit.new') }}">
                    <div class="box-body">
                                ...
                                <div class="checkbox" style="width: 100px">
                                    <label>
                                        <input type="checkbox"
                                               name="linktrust"
                                               value="1"
                                               {{ ($data->need_api_lt ? : old('linktrust')) ? " checked" : "" }}
                                               {!! ($network || $data->lt_id) ? "onclick=\"return false;\"" : "" !!}> LinkTrust
                                    </label>
                                </div>
                                ...
                                <div class="checkbox" style="width: 100px">
                                    <label>
                                        <input type="checkbox"
                                               name="everflow"
                                               value="1"
                                               {{ ($data->need_api_ef ? : old('everflow')) ? " checked" : "" }}
                                               {!! ($network || $data->ef_id) ? "onclick=\"return false;\"" : "" !!}> EverFlow
                                    </label>
                                </div>
                                <div class="input-group">
                                    <span class="input-group-addon">id</span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group {{ $errors->has('advertiser_contact') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" name="advertiser_contact" value="{{ old('advertiser_contact') ? : $data->advertiser_contact }}" placeholder="Enter Advertiser Contact Person Name" required>
                        ...
                        <div class="row">
                            <div class="col-sm-7">
                                <div class="form-group {{ $errors->has('campaign_name') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" name="campaign_name" value="{{ old('campaign_name') ? : $data->campaign_name }}" placeholder="Enter Campaign Name" required>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group {{ $errors->has('campaign_link') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" name="campaign_link" value="{{ old('campaign_link') ? : $data->campaign_link }}" placeholder="Enter Campaign Link" required>
                                ...
                                <div class="form-group {{ $errors->has('campaign_type') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="campaign_type">
                                        ...
                                        @foreach($dataCampaignType as $iter)
                                            <option value="{{ $iter->key }}" {{ (old('campaign_type') ? : $data->campaign_type) == $iter->key ? " selected" : "" }}>{{ $iter->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group {{ $errors->has('redirect') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="redirect">
                                        <option value="0" {{ (old('redirect') ? : $data->redirect) == 0 ? " selected" : "" }}>No</option>
                                        <option value="1" {{ (old('redirect') ? : $data->redirect) == 1 ? " selected" : "" }}>Yes</option>
                                    </select>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('pixel_location') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" name="pixel_location" value="{{ old('pixel_location') ? : $data->pixel_location }}" placeholder="Enter Pixel Location">
                        ...
                        <div id="block-cap" class="row">
                                ...
                                <div class="form-group {{ $errors->has('cap_unit_id') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="cap_unit_id">
                                        ...
                                        @foreach($dataCapUnit as $iter)
                                            <option value="{{ $iter->id }}" {{ (old('cap_unit_id') ? : $data->cap_unit_id ) == $iter->id ? " selected" : "" }}>{{ $iter->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div id="block-cap-monetary" class="col-sm-1" style="display: {{ $errors->has('cap_monetary') ? 'block' : 'none' }};">
                                <div class="form-group {{ $errors->has('cap_monetary') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" name="cap_monetary" value="{{ old('cap_monetary') ? : $data->cap_monetary }}" placeholder="">
                            ...
                            <div class="col-sm-1 padding-right-0 block-price">
                                <div class="form-group {{ $errors->has('price_in') ? ' has-error' : '' }}">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="price_in" value="{{ old('price_in') ? : $data->price_in }}" placeholder="" requited>
                                        <span id="price_in_rate" class="input-group-addon price-in-rate"></span>
                                    </div>
                            ...
                            <div class="col-sm-1 padding-right-0 block-price">
                                <div class="form-group {{ $errors->has('price_out') ? ' has-error' : '' }}">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="price_out" value="{{ old('price_out') ? : $data->price_out }}" placeholder="" required>
                                        <span id="price_out_rate" class="input-group-addon price-out-rate"></span>
                                    </div>
                            ...
                            <div id="block-cap-lead" class="col-sm-1">
                                <div class="form-group {{ $errors->has('cap_lead') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" name="cap_lead" value="{{ old('cap_lead') ? : $data->cap_lead }}" placeholder="">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('geo_redirect_url') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" name="geo_redirect_url" value="{{ old('geo_redirect_url') ? : $data->geo_redirect_url }}" placeholder="Enter Geo Redirect URL">
                        ...
                        <input type="hidden" name="geos_label" value="{{ old('geos_label') ? : $labelGeos }}">
                        <input type="hidden" name="currency_label" value="{{ old('currency_label') ? : $data->advertiser->currency_id }}">
...
<script>
    ...
    $(function() {
        ...
        $("#block-tracking-platform").on("change", "input[name=everflow]", function() {
            if($("input[name=everflow]").is(":checked")){
                ...
                document.location.href = '{{ route('admin.offer.edit.new', ['id' => $data->id, 'network' => 'ef']) }}';
            } else {
        ...
        $("#block-tracking-platform").on("change", "input[name=linktrust]", function() {
            if($("input[name=linktrust]").is(":checked")){
                ...
                document.location.href = '{{ route('admin.offer.edit.new', ['id' => $data->id, 'network' => 'lt']) }}';
            } else {
    ...
    function setAdvertiser()
    {
        ...
        $.ajax({
            ...
            success : function(response){
                ...
                $("input[name=currency_label]").val(response.advertiser.currency_id);
    ...
    function oldGeos()
    {
        var old_key = {!! old('geos') ? json_encode(old('geos')) : json_encode($geos_key) !!};
        var old_labels_str = "{{ old('geos_label') ? : $labelGeos }}";

        if(old_key && Object.keys(old_key).length){

            var old_labels = old_labels_str.split(",");

            $.each(old_key, function(key, value){
    ...
    function oldPriceRate()
    {
        var old_currency_id = "{{ old('currency_label') ? : $data->advertiser->currency_id }}";

        dataAdvertiser = { currency_id : old_currency_id };

        console.log(dataAdvertiser);
