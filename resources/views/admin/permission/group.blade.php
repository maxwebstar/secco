        ...
        <div class="col-md-9">
            ...
            <div class="box box-default">
                <div class="box-header">
                    <a class="btn btn-primary" href="{{ route('admin.permission.group.add') }}" role="button">Create new Group</a>
                ...
                <div class="box-body">
                    <table class="table table-bordered table-striped" id="permission-group-table">
                        <thead>
                        <tr>
                            <th>ID</th>
                            <th>Name</th>
                        ...
                        @foreach($data as $iter)
                            <tr>
                                ...
                                <td>
                                    <a type="button" class="btn btn-sm btn-info" href="{{ route('admin.permission.group.edit', ['id' => $iter->id]) }}">Edit</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
...
<script>
    $(function() {
        jDT('#permission-group-table').DataTable({
            autoWidth: false,
            processing: true,
            serverSide: false,
            searching: true,
