    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-default">
                ...
                <form class="" method="post" action="{{ route('admin.request.creative.save.add') }}">
                    <div class="box-body">
                        ...
                        <div id="block-field-form" class="disable-block">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-2 {{ $errors->has('cap_type_id') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="cap_type_id">
                                        @foreach($dataCapType as $iter)
                                            <option value="{{ $iter->id }}" {{ $iter->id == old('cap_type_id') ? " selected" : "" }}>{{ $iter->name }}</option>
                                        @endforeach;
                                ...
                                <div class="form-group col-sm-2 {{ $errors->has('cap') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" name="cap" value="{{ old('cap') }}" placeholder="">
                                ...
                                <div class="form-group col-sm-3 {{ $errors->has('type_traffic') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" name="type_traffic" value="{{ old('type_traffic') }}" placeholder="">
                            ...
                            <div class="form-group col-sm-9 {{ $errors->has('restrictions') ? ' has-error' : '' }}">
                                ...
                                <textarea class="form-control" name="restrictions" rows="5" placeholder="" required>{!! old('restrictions') !!}</textarea>
                            ...
                            <div class="form-group col-sm-9 {{ $errors->has('demos') ? ' has-error' : '' }}">
                                <label>Demos</label>
                                <textarea class="form-control" name="demos" rows="5" placeholder="" required>{!! old('demos') !!}</textarea>
                            ...
                            <div class="form-group col-sm-9 {{ $errors->has('notes') ? ' has-error' : '' }}">
                                <label>Notes</label>
                                <textarea class="form-control" name="notes" rows="5" placeholder="" required>{!! old('notes') !!}</textarea>
