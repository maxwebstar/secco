        ...
        <div class="col-md-12">
            ...
            <div class="box box-default">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">Decline Mass adjustment request (id: {{ $data->id }}) and send email</h3>
                </div>

                @if(!isset($status))

                    <form class="" method="post" action="{{ route('admin.request.mass.adjustment.save.decline') }}">
                        <div class="box-body">
