    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-default">
                ...
                <form class="" method="post" action="{{ route('admin.request.mass.adjustment.save.edit') }}">
                    <div class="box-body">
                        ...
                        <div id="block-field-form" class="disable-block">
                            <div class="row">
                                <div class="form-group col-sm-4 {{ $errors->has('date') ? ' has-error' : '' }}">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="date" placeholder="Select Date" value="{{ old('date') ? : $data->date }}" required>
                                    </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4 {{ $errors->has('click') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="click" value="{{ old('click') ? : $data->click }}"/>
                                ...
                                <div class="form-group col-sm-4 {{ $errors->has('qualified') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="qualified" value="{{ old('qualified') ? : $data->qualified }}"/>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4 {{ $errors->has('approved') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="approved" value="{{ old('approved') ? : $data->approved }}"/>
                                ...
                                <div class="form-group col-sm-4 {{ $errors->has('revenue') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="revenue" value="{{ old('revenue') ? : $data->revenue }}"/>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4 {{ $errors->has('commission') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="commission" value="{{ old('commission') ? : $data->commission }}"/>
                                ...
                                <div class="form-group col-sm-4 {{ $errors->has('type') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="type" required>
                                        ...
                                        @foreach($data->arrType as $id => $name)
                                            <option value="{{ $id }}" {{ (old('type') ? : $data->type) == $id ? " selected" : "" }}>{{ $name }}</option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="box-footer">
                        ...
                        <a class="btn btn-default pull-right" href="{{ route('admin.request.mass.adjustment.index') }}" role="button">Cancel</a>
                    </div>
                </form>
