    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-default">
                ...
                <form class="" method="post" action="{{ route('admin.request.price.save.add') }}">
                    <div class="box-body">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon">
                                        ...
                                        <input type="checkbox"
                                               ...
                                               value="1" {{ old('affiliate_all') ? ' checked' : '' }}>
                                    </span>
                                </div>
                        ...
                        <div id="block-field-form" class="disable-block">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4 {{ $errors->has('current_price_in') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="current_price_in" value="{{ old('current_price_in') }}" required/>
                                ...
                                <div class="form-group col-sm-4 {{ $errors->has('current_price_out') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="current_price_out" value="{{ old('current_price_out') }}" required>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4 {{ $errors->has('price_in') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="price_in" value="{{ old('price_in') }}" required/>
                                ...
                                <div class="form-group col-sm-4 {{ $errors->has('price_out') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="price_out" value="{{ old('price_out') }}" required>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6 {{ $errors->has('cap_change') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="cap_change">
                                        <option></option>
                                        <option value="1" {{ old('cap_change') == 1 ? " selected" : "" }}>Yes</option>
                                        <option value="0" {{ old('cap_change') == 0 ? " selected" : "" }}>No</option>
                                    </select>
                                ...
                                <div class="form-group col-sm-6 {{ $errors->has('type') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="type">
                                        ...
                                        @foreach($dataType as $type_id => $type_name)
                                            <option value="{{ $type_id }}" {{ old('type') == $type_id ? " selected" : "" }}>{{ $type_name }}</option>
                                        @endforeach
                                    </select>
