    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-default">
                ...
                <form class="" method="post" action="{{ route('admin.request.status.save.add') }}">
                    <div class="box-body">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6 {{ $errors->has('lt_new_status') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="lt_new_status" required>
                                        ...
                                        <option value="Dead" {{ old('lt_new_status') == "Dead" ? " selected" : "" }}>Dead</option>
                                        <option value="Paused" {{ old('lt_new_status') == "Paused" ? " selected" : "" }}>Paused</option>
                                        <option value="PrivateLive" {{ old('lt_new_status') == "PrivateLive" ? " selected" : "" }}>Private</option>
                                        <option value="PublicLive" {{ old('lt_new_status') == "PublicLive" ? " selected" : "" }}>Public</option>
                                        <option value="Testing" {{ old('lt_new_status') == "Testing" ? " selected" : "" }}>Testing</option>
                                    </select>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6 {{ $errors->has('ef_new_status') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="ef_new_status" required>
                                        <option value="">Select Status</option>
                                        <option value="active" {{ old('ef_new_status') == "active" ? " selected" : "" }}>Active</option>
                                        <option value="paused" {{ old('ef_new_status') == "paused" ? " selected" : "" }}>Paused</option>
                                        <option value="pending" {{ old('ef_new_status') == "pending" ? " selected" : "" }}>Pending</option>
                                        <option value="deleted" {{ old('ef_new_status') == "deleted" ? " selected" : "" }}>Deleted</option>
                                    </select>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6 {{ $errors->has('mass_notice') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="mass_notice">
                                        <option value="1" {{ old('mass_notice') == 1 ? " selected" : "" }}>Yes</option>
