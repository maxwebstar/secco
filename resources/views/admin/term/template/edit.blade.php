                ...
                <form class="" method="post" action="{{ route('admin.term.template.save') }}">
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('display_name') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="display_name" placeholder="Enter Display Name" value="{{ old('display_name') ? : $data->display_name }}" required>
                        ...
                        <div class="form-group {{ $errors->has('text') ? ' has-error' : '' }}">
                            ...
                            <textarea class="form-control tinymce-editor" rows="30" name="text" placeholder="Enter Text">{!! old('text') ? : $data->text !!}</textarea>
                            @if ($errors->has('text'))
                                <span class="help-block">
                        ...
                        <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="description" placeholder="Enter Description" rows="5">{!! old('description') ? : $data->description !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('position') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="position" placeholder="Enter Position" value="{{ old('position') ? : $data->position }}" required>
                        ...
                        <div class="form-group {{ $errors->has('by_default') ? ' has-error' : '' }}">
                            <div class="checkbox">
                                <label><input type="checkbox" name="by_default" value="1" {{ (old('by_default') ? : $data->by_default) ? " checked" : "" }}><strong>By Default</strong></label>
                            </div>
